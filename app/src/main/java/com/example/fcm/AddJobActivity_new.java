    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_fixed.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent( AddJobActivity_new.this, Add_fixed_rate.class));
//                customType(Calendar_main_activity.this,"fadein-to-fadeout");
        ...
        add_hour.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( AddJobActivity_new.this, Add_hour_rate.class));
//                customType(Calendar_main_activity.this,"fadein-to-fadeout");
                overridePendingTransition(0, 0);
                finish();
        ...
        add_shift.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( AddJobActivity_new.this, Add_shift_rate.class));
//                customType(Calendar_main_activity.this,"fadein-to-fadeout");
                overridePendingTransition(0, 0);
                finish();
            }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case  R.id.statistika:
                        ...
                        startActivity(new Intent( AddJobActivity_new.this, Statistic_activity.class));
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case  R.id.nastroiki:
                        item.setChecked( true );
                        startActivity(new Intent( AddJobActivity_new.this, Settings_activity.class));
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case  R.id.not_pay:
                        item.setChecked( true );
                        startActivity(new Intent( AddJobActivity_new.this, No_pay_activity.class));
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case R.id.calendar_work:
                        ...
                        item.setChecked(true);
                        startActivity(new Intent( AddJobActivity_new.this, Calendar_main_activity.class));
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case R.id.add_job:
                        item.setChecked(true);
                        startActivity(new Intent( AddJobActivity_new.this, Add_work_template_activity.class));
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
