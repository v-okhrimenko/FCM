...
public class Tempale_job_new {
    ...
    public Tempale_job_new() {
    }

    public Tempale_job_new(String template_name, String valuta, String tempalte_type, Integer price_hour, Integer price_fixed, Integer price_smena, Integer smena_duration, Integer overtime_pocent, Integer rounded_minutes, Integer half_shift_hours, Boolean half_shift) {
