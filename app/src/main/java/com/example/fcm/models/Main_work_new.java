...
public class Main_work_new {
    ...
    public Main_work_new() {
    }

    public Main_work_new(String name, String valuta, String tempalte_type, String discription, Integer price_hour, Integer price_fixed, Integer price_smena, Integer smena_duration, Integer overtime_pocent, Integer rounded_minut, Integer half_shift_hours, Boolean status, Boolean needFinish, Boolean half_shift, Date date, Date alarm1, Date alarm2, int uniqId, Date start, Date end, Integer otrabotanoMinutOverTime, Integer otrabotanoMinutHourlyTime, Float zarabotanoFinal, Float zarabotanoOvertimeFinal) {
        this.name = name;
        this.valuta = valuta;
