...
public class Add_fixed_rate extends AppCompatActivity implements Date_Add_In_Tariff_Adapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_CalendarSelect.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (x ==0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder( Add_fixed_rate.this);
                    LayoutInflater inflater = LayoutInflater.from( Add_fixed_rate.this);
        ...
        btn_Cancel.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( Add_fixed_rate.this, Calendar_main_activity.class));
            ...
            public void onClick(View v) {
                ...
                if (et_JobName.getText().toString().isEmpty()) {
                    ...
                    if (selectDates.isEmpty()) {
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder( Add_fixed_rate.this );
                        LayoutInflater inflater = LayoutInflater.from( Add_fixed_rate.this );
    ...
    private void addJobToFireBase() {
        ...
        for (String i:selectDates) {
            ...
            if (ed_FixedPrice.getText().toString().isEmpty()) {
                ...
                main_work_new.setPrice_fixed( Integer.parseInt(ed_FixedPrice.getText().toString()) );
            }
            ...
            noteRef_addWork_Full.document().set(main_work_new)
                    .addOnSuccessListener( new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            ln.setBackgroundTintList( ContextCompat.getColorStateList(Add_fixed_rate.this, R.color.green_lite) );
...
//                                    toast.setGravity( Gravity.CENTER_VERTICAL, 0, 0);
                    ...
                    .addOnFailureListener( new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            LinearLayout ln = layout.findViewById( R.id.custom_toast_container );
                            ln.setBackground( getResources().getDrawable( R.drawable.event_bg ) );
                            ln.setBackgroundTintList( ContextCompat.getColorStateList( Add_fixed_rate.this, R.color.red ) );
