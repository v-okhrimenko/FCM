...
import com.example.fcm.adapter.Calendar_noPay_rv;
...
public class No_pay_activity extends AppCompatActivity {
...
//    private ImageButton menu;
    ...
    public static Calendar_noPay_rv adapter;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case  R.id.statistika:
                        ...
                        startActivity(new Intent( No_pay_activity.this, Statistic_activity.class));
                    ...
                    case  R.id.nastroiki:
                        item.setChecked( true );
                        startActivity(new Intent( No_pay_activity.this, Settings_activity.class));
                        //customType(No_pay_activity.this,"fadein-to-fadeout");
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case  R.id.need_finish:
                        item.setChecked( true );
                        startActivity(new Intent( No_pay_activity.this, OldNoFinishActivity.class));
                    ...
                    case R.id.calendar_work:
                        ...
                        item.setChecked(true);
                        startActivity(new Intent( No_pay_activity.this, Calendar_main_activity.class));
                        //customType(No_pay_activity.this,"fadein-to-fadeout");
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case R.id.new_work:
                        item.setChecked(true);
                        startActivity(new Intent( No_pay_activity.this, AddJobActivity_new.class));
                        //customType(No_pay_activity.this,"fadein-to-fadeout");
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case R.id.add_job:
                        item.setChecked(true);
                        startActivity(new Intent( No_pay_activity.this, Add_work_template_activity.class));
                        //customType(No_pay_activity.this,"fadein-to-fadeout");
                        overridePendingTransition(0, 0);
                        finish();
                        return true;
                    ...
                    case R.id.exit_to_login:
                        ...
                        startActivity(new Intent( No_pay_activity.this, MainActivity.class));
                        //customType(No_pay_activity.this,"fadein-to-fadeout");
                        overridePendingTransition(0, 0);
                        finish();
                }
                ...
                .addOnSuccessListener( new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (chek_no_info.isEmpty()) {
                            ...
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder( No_pay_activity.this );
                            LayoutInflater inflater = LayoutInflater.from( No_pay_activity.this );
...
//        scek_sum_no_pay();
        ...
        FirestoreRecyclerOptions<Main_work_new> options = new FirestoreRecyclerOptions.Builder<Main_work_new>()
                ...
                .build();
        adapter = new Calendar_noPay_rv( options );
        recyclerView = findViewById( R.id.main_work_rv_nopay );
...
//
            ...
            public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addSwipeLeftBackgroundColor( ContextCompat.getColor( No_pay_activity.this, R.color.white ) )
                        .addSwipeLeftActionIcon( R.drawable.ic_monetization )
                        .addSwipeRightActionIcon( R.drawable.del_icon_red )
                        .addSwipeRightBackgroundColor( ContextCompat.getColor( No_pay_activity.this, R.color.white ))
                        .create()
                        .decorate();
        ...
        adapter.setOnItemClickListener( new Calendar_noPay_rv.onItemClickListener() {
            @Override
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                switch (jobType){
                    case "fixed":
                        Intent intent = new Intent(No_pay_activity.this, FixedJobRewiev.class);
                    ...
                    case "for smena":
                        ...
                        Intent intent_forSmena = new Intent(No_pay_activity.this, ForSmenaJobRewiew_new.class);
                    ...
                    case "for hour":
                        ...
                        Intent intent_forHour = new Intent(No_pay_activity.this, ForHourJobRewiev.class);
                                           ...
                                           public void onSuccess(DocumentSnapshot documentSnapshot) {
                                               ...
                                               try {
                                                   ...
                                                   if(infoToFs.getImg() != null){
                                                       ...
                                                       Picasso.with( No_pay_activity.this ).load( myUri ).into( avatar );
