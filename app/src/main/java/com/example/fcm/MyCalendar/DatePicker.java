...
//    Calendar calendar = Calendar.getInstance( Locale.getDefault() );
    ...
    DatePicker_GridAdapter myCalendarGridAdapter;
...
//        CollectEventMonth();
        myCalendarGridAdapter = new DatePicker_GridAdapter( context, dates, calendar, eventsList, test );
        gridView.setAdapter( myCalendarGridAdapter );

        myCalendarGridAdapter.setOnLongClick( new CalendarView_GridAdapter.onLongClickListener() {
            @Override
