...
public class CalendarView_GridAdapter extends ArrayAdapter {
    ...
    static List<CalendarView_Events> events;
    LayoutInflater inflater;
    TextView sga;
    private int position_to;

    private CalendarView_GridAdapter.onLongClickListener listener;
    private CalendarView_GridAdapter.onClickListener listener_shot;



    public CalendarView_GridAdapter(@NonNull Context context, List<Date> dates, Calendar currentDate, List<CalendarView_Events> events, ArrayList<String> test) {
