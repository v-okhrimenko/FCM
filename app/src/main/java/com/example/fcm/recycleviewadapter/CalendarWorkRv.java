...
public class CalendarWorkRv extends FirestoreRecyclerAdapter<MainWork, CalendarWorkRv.CalendarHolder> {
    ...
    public CalendarWorkRv(@NonNull FirestoreRecyclerOptions<MainWork> options) {
        super( options );
    }
