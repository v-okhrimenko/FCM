    ...
    private void addJobToFireBase() {
        ...
        for (String i:selectDates) {
            ...
            if (et_price_for_smena.getText().toString().isEmpty()) {
                ...
                main_work.setPrice_smena( Integer.parseInt(et_price_for_smena.getText().toString()) );
            }
            if(rounded_minutes.getText().toString().isEmpty() || Integer.valueOf(rounded_minutes.getText().toString().trim())>59 ){
            ...
            if (et_dlitelnost_smeny.getText().toString().isEmpty()) {
                main_work.setSmena_duration(0);
            } else {
                main_work.setSmena_duration( Integer.parseInt(et_dlitelnost_smeny.getText().toString()) );
            }

            if (et_procent_overtime.getText().toString().isEmpty()) {
                main_work.setOvertime_pocent( 0 );
            } else {
                main_work.setOvertime_pocent( Integer.parseInt(et_procent_overtime.getText().toString()));
            }

            if (switch_half_shift.isChecked()){
                main_work.setHalf_shift( true );
                main_work.setHalf_shift_hours( Integer.parseInt( et_half_shift.getText().toString().trim() ) );
            }
            else{
                main_work.setHalf_shift( false );
