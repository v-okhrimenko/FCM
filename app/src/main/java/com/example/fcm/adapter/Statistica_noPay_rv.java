...
public class Statistica_noPay_rv extends FirestoreRecyclerAdapter<Main_work_new, Statistica_noPay_rv.CalendarHolder> {
    ...
    public Statistica_noPay_rv(@NonNull FirestoreRecyclerOptions<Main_work_new> options) {
        super( options );
