...
public class statistica_rv extends FirestoreRecyclerAdapter<Main_work_new, statistica_rv.CalendarHolder> {
    ...
    public statistica_rv(@NonNull FirestoreRecyclerOptions<Main_work_new> options) {
        super( options );
