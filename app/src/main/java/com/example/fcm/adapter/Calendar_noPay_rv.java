...
public class Calendar_noPay_rv extends FirestoreRecyclerAdapter<Main_work_new, Calendar_noPay_rv.CalendarHolder> {
    ...
    public Calendar_noPay_rv(@NonNull FirestoreRecyclerOptions<Main_work_new> options) {
        super( options );
